...
func (_m *MockDb) GetUserQuotesOnGuild(ctx context.Context, authorID models.ID, guildID models.ID) ([]models.Quote, error) {
...
func (_c *MockDb_GetUserQuotesOnGuild_Call) Run(run func(ctx context.Context, authorID models.ID, guildID models.ID)) *MockDb_GetUserQuotesOnGuild_Call {
	_c.Call.Run(func(args mock.Arguments) {
