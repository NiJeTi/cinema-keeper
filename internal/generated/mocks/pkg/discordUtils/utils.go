...
func (_m *MockUtils) GetVoiceChannelUsers(
	guild types.ID, channel types.ID,
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(types.ID, types.ID) (
		[]*discordgo.Member, error,
	)); ok {
...
//   - guild types.ID
//   - channel types.ID
func (_e *MockUtils_Expecter) GetVoiceChannelUsers(
	guild interface{}, channel interface{},
) *MockUtils_GetVoiceChannelUsers_Call {
	return &MockUtils_GetVoiceChannelUsers_Call{
		Call: _e.mock.On(
			"GetVoiceChannelUsers", guild, channel,
		),
	}
}

func (_c *MockUtils_GetVoiceChannelUsers_Call) Run(
	run func(
		guild types.ID, channel types.ID,
	),
) *MockUtils_GetVoiceChannelUsers_Call {
...
func (_c *MockUtils_GetVoiceChannelUsers_Call) Return(
	_a0 []*discordgo.Member, _a1 error,
) *MockUtils_GetVoiceChannelUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUtils_GetVoiceChannelUsers_Call) RunAndReturn(
	run func(
		types.ID, types.ID,
	) ([]*discordgo.Member, error),
) *MockUtils_GetVoiceChannelUsers_Call {
...
func (_m *MockUtils) Respond(
	...
	if rf, ok := ret.Get(0).(func(
		*discordgo.InteractionCreate, *discordgo.InteractionResponse,
	) error); ok {
...
//   - interaction *discordgo.InteractionCreate
//   - response *discordgo.InteractionResponse
func (_e *MockUtils_Expecter) Respond(
	interaction interface{}, response interface{},
) *MockUtils_Respond_Call {
	return &MockUtils_Respond_Call{
		Call: _e.mock.On(
...
func (_c *MockUtils_Respond_Call) Run(
	run func(
		interaction *discordgo.InteractionCreate,
		response *discordgo.InteractionResponse,
	),
	...
	_c.Call.Run(
		func(args mock.Arguments) {
			run(
				args[0].(*discordgo.InteractionCreate),
				args[1].(*discordgo.InteractionResponse),
			)
		},
	)
	return _c
...
func (_c *MockUtils_Respond_Call) RunAndReturn(
	run func(
		*discordgo.InteractionCreate, *discordgo.InteractionResponse,
	) error,
) *MockUtils_Respond_Call {
